        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubArea = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    NumberOfRooms = table.Column<int>(type: "int", nullable: true),
                    AreaSize = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    ...
                    RequiredStudentsCount = table.Column<int>(type: "int", nullable: true),
                    AllowedColleges = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentRequests_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
